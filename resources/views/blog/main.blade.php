...
@section('content')
        ...
        <article class="blog-post">
            ...
            <p class="blog-post-meta float-end mt-2">ارسال شده در تاریخ <a>{{$post->created_at}}</a> توسط <a href="#">{{$post->user->name}}</a>@if(Auth::check() && Auth::user()->role->role =='admin') | <a href="{{route('blog.blog.edit',$post)}}">ویرایش مطلب</a> |&nbsp</p>
